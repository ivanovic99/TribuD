...
const ProductDetails = () => {
  ...
  const handleModifyProduct = () => {
    const confirmAction = window.confirm('¿Estás seguro de que quieres modificar este producto?');
    if (confirmAction) {
  ...
  return (
    <>
      ...
      <div className="container max-w-7xl mx-auto mt-8">
        <div className="mb-4">
          <h1 className="text-3xl font-bold decoration-gray-400">Detalles del Producto</h1>
        </div>
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        Su Producto ha sido eliminado exitosamente.
                      </p>
                    </div>
                  </div>
                </div>
