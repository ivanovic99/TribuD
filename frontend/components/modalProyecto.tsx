...
export default function ModalProyecto({ modalOpen, setModalOpen, proyecto }:
    {
        modalOpen: boolean;
        setModalOpen: (estado: boolean) => void;
        proyecto: ProyectoInfoProps
    }) {
    ...
    const [fechaEstimadaFinalizacion, setFechaFinalizacion] = useState(proyecto.fechaEstimadaFinalizacion)
    ...
    const proyectoNuevo = () => {
        const nuevoProyecto: ProyectoInfoProps = {
            id: proyecto.id,
            nombre,
            descripcion,
            cliente,
    ...
    const showModalProyecto = () => {
        if (modalOpenEditar) {
            return <ModalEditarProyecto modalOpen={modalOpenEditar} setModalOpen={setModalOpenEditar} proyecto={proyectoNuevo()} />
        }
        else return <></>
    }
                        ...
                        <form>
                            ...
                            <div className="grid md:grid-cols-4 md:gap-6">
                                <div className="relative z-0 w-full mb-6 group">
                                    <input type="date"
                                        disabled={esEditable()}
                                        defaultValue={formatDate(proyecto.fechaEstimadaFinalizacion)}
